...
map.getView().fit([-12571930.903260, 4282862.082459, -10495367.114725, 5730064.785913], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GolmapV2</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1772 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Welcome to Goldmap! This map is designed to visualize geological and geochemical indicators of gold within the United States using heatmaps<br /><br />This project uses Geological and Mining Data from the USGS, US mineral Deposit Database, deep and shallow geochemical data from the MRDS<br /><br />At the moment, the map encompasses the entire contiguous US and can identify Hotzones (where layers overlap)<br /><br />Included in the repository is also a Qgis web application for use on websites. <br /><br />Layers:<br /><br />Geological heatmap<br />Geochemical heatmap<br />US Mining Zones<br /><br />Point data with all attributes also included. <br /><br /><br />Composite Heatmap Sample:<br />![GOLDMAPcomposite](https://github.com/Kcslade/Goldmap/assets/173574308/ef61607f-aec1-453d-8992-c11aeaad4328)<br /><br />Qgis Project and Data Download:<br /><br />(https://drive.google.com/file/d/1qvzUw4_HtoIhvw_-78DDLrEuV7Bowvyx/view?usp=sharing)<br /><br />Things to note:<br /><br />- The composite heatmap is a composite of all the normal maps, weighted to favor the geochemical data first, the geological data second, and the landsat band composite very little(due to its quality).<br /><br />-Geological heatmap is based on the presence of the folliowing geology:<br /><br />Greenstone (Greenstone Belts), Granite, Granodiorite, Diorite, Rhyolite, Schist, Amphibolite, Banded Iron Formation (BIF), Pegmatite, Serpentinite, Basalt and Basaltic-andesite, Granulite, Kimberlite<br /><br /><br />-Geochemical heatmap is based on the following elements and minerals, with elements recieving greater weight. <br />Arsenic (As)<br />Antimony (Sb)<br />Bismuth (Bi)<br />Silver (Ag)<br />Copper (Cu)<br />Lead (Pb)<br />Zinc (Zn)<br />Tungsten (W)<br />Iron (Fe)<br />Sulfur (S)<br />Hematite<br />Goethite<br />Pyrite<br />Serpentine<br />Quartz<br />- Landsat layer is a band ratio calculation based on a somewhat low quality Landsat 8 composite, the band ratios are used to highlight potential zones of alteration. ';
            }
